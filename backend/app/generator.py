...
def build_visual_assets(query: str, category: str, visual_template: str) -> dict:
    ...
    if category == "chimney_cap":
        return {
            ...
            "worker": "same worker in tan work shirt, blue jeans, gloves, and roof-safe footwear, with simple consistent illustrated facial features when visible",
    ...
    if category == "insulation":
        return {
            ...
            "worker": "same worker wearing long sleeves, gloves, dust mask, and safety glasses, with visible simple illustrated facial features when the mask or angle allows",
    ...
    if category == "plumbing_sink":
        return {
            ...
            "worker": "same worker in tan shirt and work gloves, with simple consistent illustrated facial features when visible",
    ...
    return {
        ...
        "worker": "same recurring worker character style across steps, with simple consistent illustrated facial features when visible",
        "tools": [],
